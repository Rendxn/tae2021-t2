...
```{r, include=FALSE}
datos <-read.csv('../data/base_trabajo_segmentacion.csv', header = TRUE, sep = ";")
```
...
En estos ciclos se busca identificar el tiempo que tardará la empresa en recuperar la inversión de su materia prima, así, un ciclo de negocio bueno tendrá valores menores en términos de tiempo en comparación a un ciclo de negocio malo [@Montagud; @EFXTO].
