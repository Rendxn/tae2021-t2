...
tomado de [metodos hclust]( https://uc-r.github.io/hc_clustering)
...
[metodo de ward ](http://repositorio.lamolina.edu.pe/bitstream/handle/UNALM/3384/dongo-roman-andie-bryan.pdf?sequence=1&isAllowed=y)
...
#Todas las funciones reciben los parametros de :

#Num_group = Numero de grupos
#operative = Tipo de operacion que se aplica a cada columna 
#nombre_grafica = Nombre del titulo de la grafica 

# la funcion toma los parametros y aplica la funcion a cada colmna por grupos y enrtega barplot de la operacion segmentada por grupos y columna 
# todas las funciones se generan de la misma forma , cambiando el tipo de variable permitiendo aplicar diferentes funciones a distintos grupos 
...
tomado de [cxc y cxp3](https://repositorio.sena.edu.co/handle/11404/3163)
...
[rotacion inventario]( https://repositorio.ucv.edu.pe/bitstream/handle/20.500.12692/30149/Campos_ASM.pdf?sequence=4&isAllowed=y)
...
tomado de [ciclo financiero]( https://psicologiaymente.com/organizaciones/ciclo-financiero-empresa)
tomado de [ciclo de negocio ](https://efxto.com/diccionario/ciclo-de-negocio)
...
[iconos png ](https://www.freepik.com) y [iconos png](https://www.flaticon.es)
