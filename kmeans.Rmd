...
# TODO: rownames(df) <- nit_list
# Per aparentemente hay NITs repetidos e.g. C-183565186626737291
```
...
# TODO: Organizar estilos de tablas.
# i.e. PC1:PC25
```
...
```{r k2-means-exec}
# KMeans con 2 centros y 50 configuraciones iniciales aleatorias.
# TODO: Verificar cuál de los tres (k3, k2 y k2pp) es mejor...
